...
const ModuleHashingError = require("webpack/lib/ModuleHashingError");
...
const { WEBPACK_MODULE_TYPE_RUNTIME } = require("webpack/lib/ModuleTypeConstants");
...
const { getOrInsert } = require("webpack/lib/util/MapHelpers");
const WeakTupleMap = require("webpack/lib/util/WeakTupleMap");
...
/** @typedef {import("webpack/lib/Compiler").CompilationParams} CompilationParams */
...
/** @typedef {import("webpack/lib/Module").BuildInfo} BuildInfo */
/** @typedef {import("webpack/lib/NormalModule").NormalModuleCompilationHooks} NormalModuleCompilationHooks */
...
/** @typedef {import("webpack/lib/TemplatedPathPlugin").TemplatePath} TemplatePath */
/** @typedef {import("webpack/lib/util/Hash")} Hash */
/**
 * @template T
 * @typedef {import("webpack/lib/util/deprecation").FakeHook<T>} FakeHook<T>
 */
