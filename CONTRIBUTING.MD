...
Fork and then clone [ui5-helper](https://github.com/sohail9744/ui5-helper.git)

```bash
npm run dev
```
> :warning: **NOTE** 
Before starting you need to make sure your ui5-helper is in the root file of any ui5 projects
